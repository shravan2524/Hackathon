...
export default function WishlistPage() {
  ...
  function remove(item, e) {
    console.log(item);
    axios
      .post("http://localhost:5000/api/removefromwishlist", { email, item })
      .then((e) => {
        console.log(e.data);
  ...
  function movetocart(item, e) {
    console.log(item);
    axios
      .post("http://localhost:5000/api/movetocart", { email, item })
      .then((e) => {
        console.log(e.data);
        // alert("Moved to Cart");
        setMsg({
  ...
  useEffect(() => {
    axios
      .post("http://localhost:5000/api/getwishlist", { email })
      .then((e) => {
