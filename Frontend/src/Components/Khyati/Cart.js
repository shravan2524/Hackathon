...
export default function Cart() {
	...
	useEffect(() => {
		...
		axios.post("http://localhost:5000/api/cart", { email })
        .then((e) => {
            console.log(e.data);
	...
	function movetowishlist(item , e){
		axios.post("http://localhost:5000/api/removefromcart", {item, email, movetowishlist : "true"})
		.then((e)=>{
			console.log(e.data);
	...
	function removefromcart(item ,e){
		console.log(item);
		axios.post("http://localhost:5000/api/removefromcart", {item, email, movetowishlist : "false"})
		.then((e)=>{
			console.log(e.data);
		...
		<div className="CartCard" key={item._id}>
			...
			<div className="Cartcard_content">
				...
				<div>
					...
					/>
					<img src='./images/dustbin.png' className="CartwishlistImg" onClick={(e) => removefromcart(item ,e)} />
				</div>
			</div>
